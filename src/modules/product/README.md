...
- Confirmar que `CreateProductDto` incluya `category_id` y que `create()` en el service lo use para asociar la categoría.
- Confirmar que `product.module.ts` tenga `imports: [TypeOrmModule.forFeature([Product])]`.